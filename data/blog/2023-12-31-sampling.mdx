...
You can adjust the mix ratio, mean vector location and variance matrix (here I assume no covariance between $x_1$ and $x_2$). Now, use your imagination, this distribution will have 3 modes at different centers and the one centered at $[8.0, 8.0]$ should have the largest weights.
